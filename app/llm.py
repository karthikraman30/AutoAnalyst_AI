...
# BEST PRACTICE: Set this in your terminal: export GEMINI_API_KEY="your_key"
# FOR NOW: You can paste it here to test.
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyCMA3N5cI5WLRbPh903lF_nYl8s7s-3PYI")
